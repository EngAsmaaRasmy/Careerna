@extends('layouts.base ' ,['title'=>'CAREERNA | Login as Employer'])
  ...
  <header id="header" class="fixed-top d-flex align-items-center">
    <div class="container d-flex align-items-center">
      ...
      <nav id="navbar" class="navbar order-last order-lg-0">
        <ul>
          <div class="btn-wrap">
            <button class="btn btn-primary" onclick= "location.href='{{ route ('employee.show.login.form') }}'"> Employee?</button>
          </div>
        </ul>
        ...
        <div class="container py-5 h-100">
            <div class="row d-flex justify-content-center align-items-center h-100">
              <div class="col-12 col-md-8 col-lg-6 col-xl-6">
                        <form action="{{ route('employer.login') }}" method="post" role="form" class="php-email-form">
                          {{ csrf_field() }}
                        ...
                        <div class="text-center"> <p>New to Carrerna? <a href="{{ route('employer.show.register.form') }}"> Join now</a></p></div>
                        </form>
              </div>
            </div>
          </div>
