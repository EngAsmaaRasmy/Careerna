@extends('layouts.base ' ,['title'=>'CAREERNA | Saved Jobs']) 
@section("content")
    <!-- ======= Header ======= -->
               ...
               <!-- Stack the columns on mobile by making one full-width and the other half-width -->
                <div class="row">
                    <div class="col-md-8 m-auto">
                        <div>
                            <h1 class="style">{{$count}} Active Saved Job</h1>
                            ...
                            <div class="col-lg-12 col-md-4 d-flex align-items-stretch" data-aos="fade-right">
                                <div class="col-lg-12 d-flex flex-column justify-contents-center " data-aos="fade-left">
                                    ...
                                    <div class="content1 pt-4 pt-lg-0">
                                        ...
                                        <hr>
                                        <button class="css-1kiywu"><a class="css-1kiywu" href="{{route('deleteSaveJob', [$job->job->id])}}"><i
